...
CREATE ROLE administrateur ADMIN role_membre PASSWORD ’iut_villetaneuse_2022_admin’;
CREATE ROLE responsable_matiere ADMIN role_membre PASSWORD ’iut_villetaneuse_2022_matiere’;
CREATE ROLE enseignant ADMIN role_membre PASSWORD ’iut_villetaneuse_2022’;
